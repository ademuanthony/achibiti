...
const (
	AppName  string = "Achibiti"
	AppMajor uint   = 0
	AppMinor uint   = 1
	AppPatch uint   = 1
)

// go build -v -o achibiti -ldflags "-X github.com/ademuanthony/achibiti/version.appPreRelease= -X github.com/ademuanthony/achibiti/version.appBuild=`git rev-parse --short HEAD`"
var (
